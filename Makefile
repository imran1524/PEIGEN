#CC=g++ -fopenmp
CC=clang++ -Xpreprocessor -fopenmp -I/usr/local/include -L/usr/local/lib -lomp
CFLAGS= -mavx2 -std=c++14 -O3 -Wall -Wextra -pedantic

#% clang++ -Xpreprocessor -fopenmp -I/usr/local/include -L/usr/local/lib -lomp  main.cpp -o main -mavx2 -std=c++14 -Wall -Wextra -pedantic -DEVA
